...
const appOperationsRouter = require('./chat-api/routers/app_operations')
const groupRouter = require('./chat-api/routers/group')
const app = express();
...
app.use('/updateApp', appOperationsRouter)
